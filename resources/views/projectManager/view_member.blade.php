...
<br>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            ...
            </div> <center><strong style ="padding: 25px 50px;" class="card-title">Project Member</strong><center>
...
<div class="col-lg-10">
    <div class="card">
        <div class="card-header">
            ...
            <strong><center>View Project</center></strong> 
        ...
        <form action="/editleader" method="post" enctype="multipart/form-data" class="form-horizontal">    
            ...
            <input type="hidden" value="{{$x['project_id']}}" name="project_id">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="date" id="rd" name="sd" value="{{$x['start_date']}}" class="form-control"disabled><small class="help-block form-text"></small></div>
                </div>

                <div class="row form-group">
                    <div class="col col-md-3"><label for="password-input" class=" form-control-label">End Date</label></div>
                    <div class="col-12 col-md-9"><input type="date" id="rd" name="ed" value="{{$x['end_date']}}" class="form-control" disabled><small class="help-block form-text"></small></div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select  name="select6" class="form-control"disabled>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select  name="select7" id="select" class="form-control"disabled>
